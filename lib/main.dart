    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.center,
          children: <Widget>[
            Text('Nama: Muhammad Ilmi Ramadhan'),
            Text('NPM: 2110020017'),
            Text('Kelas: 5A SI Non Reg Banjarmasin'),
            Text('Kontak: ilmi.ramadhan123@gmail.com'),
            Text('Alamat: Jl. Jend Sudirman, Komplek Haur Kuning Permai, Kecamatan Tapin Utara, Kabupaten Tapin'),
          ],
        ),
      ),
    );
